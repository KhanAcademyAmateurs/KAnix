var program = function(pjs) {
    with (pjs) {
         ...
         *                  JSLITE (CLI Text Editor => CLITE => JS, not C => JSLITE), fix dose bugs (v0.1.9, v0.9)
         *        Release?
         * @CHANGES: Multiple bug fixes to KASH v0.8b and KAnix v0.1.6, added PJS execution
         * 
         * P/JS EXECUTION
         * A PJS script looks like this:
         *  function main () {
         *      with (__env__) {
         *          ... code ...
         *          return something; // Whatever main() returns is the output to the console.
         *                            // If you leave it out, it outputs "undefined".
         *      }
         *  }
         * The main function wrapper & with block is necessary for any actual PJS code.
         * You can do plain operations without PJS like so:
         *  ... code ...
         *  return something;
         * No main function or with block required. However, not using the main function is advised against:
         *  function main () {
         *      ... code ...
         *      return something;
         *  }
        ...
        */
        ...
        // File constructor. a = path, t = text, o = owner, g = group
        ...
        // Directory constructor. a = path, o = owner, g = group
        ...
        // Change permissions on directory. If not allowed, return 1, else return nothing
        Directory.prototype.chmod = function (p) {
            if (!writable(this)) {
                return 1;
            }
        ...
        // Execute contents of file as JavaScript code. Takes path string. Output result. If not allowed, return 1, if path invalid, return 2, if directory, return 3.
        var sys = function (p) {
            var o = getPath(path(p));
        ...
        // KASH commands. To be moved sometime in relatively far future to system call files.
...
var theProcessing = new Processing(canvas, program);
